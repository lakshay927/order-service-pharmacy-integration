...
export class PharmacyController {
  ...
  async getOrderById(req: Request, res: Response): Promise<void> {
    const pharmacyName = req.params.pharmacyName; // Assuming pharmacy name is passed as URL parameter
    const orderId = req.params.orderId; // Assuming order ID is passed as URL parameter
